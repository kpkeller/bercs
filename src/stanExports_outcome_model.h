...
namespace model_outcome_model_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_outcome_model");
    reader.add_event(5, 5, "include", "/data/outcome_dim.stan");
    reader.add_event(5, 0, "start", "/data/outcome_dim.stan");
    reader.add_event(13, 8, "end", "/data/outcome_dim.stan");
    reader.add_event(13, 6, "restart", "model_outcome_model");
    reader.add_event(14, 7, "include", "/data/outcome_data.stan");
    reader.add_event(14, 0, "start", "/data/outcome_data.stan");
    reader.add_event(22, 8, "end", "/data/outcome_data.stan");
    reader.add_event(22, 8, "restart", "model_outcome_model");
    reader.add_event(23, 9, "include", "/data/outcome_hyperprior.stan");
    reader.add_event(23, 0, "start", "/data/outcome_hyperprior.stan");
    reader.add_event(35, 12, "end", "/data/outcome_hyperprior.stan");
    reader.add_event(35, 10, "restart", "model_outcome_model");
    reader.add_event(40, 15, "include", "/data/outcome_tdata.stan");
    reader.add_event(40, 0, "start", "/data/outcome_tdata.stan");
    reader.add_event(43, 3, "end", "/data/outcome_tdata.stan");
    reader.add_event(43, 16, "restart", "model_outcome_model");
    reader.add_event(45, 18, "include", "/parameters/parameters_outcome.stan");
    reader.add_event(45, 0, "start", "/parameters/parameters_outcome.stan");
    reader.add_event(55, 10, "end", "/parameters/parameters_outcome.stan");
    reader.add_event(55, 19, "restart", "model_outcome_model");
    reader.add_event(59, 23, "include", "tparameters/tparameters_outcome_define.stan");
    reader.add_event(59, 0, "start", "tparameters/tparameters_outcome_define.stan");
    reader.add_event(64, 5, "end", "tparameters/tparameters_outcome_define.stan");
    reader.add_event(64, 24, "restart", "model_outcome_model");
    reader.add_event(65, 25, "include", "tparameters/tparameters_outcome_update.stan");
    reader.add_event(65, 0, "start", "tparameters/tparameters_outcome_update.stan");
    reader.add_event(77, 12, "end", "tparameters/tparameters_outcome_update.stan");
    reader.add_event(77, 26, "restart", "model_outcome_model");
    reader.add_event(84, 33, "include", "/model/model_stem_outcome.stan");
    reader.add_event(84, 0, "start", "/model/model_stem_outcome.stan");
    reader.add_event(98, 14, "end", "/model/model_stem_outcome.stan");
    reader.add_event(98, 34, "restart", "model_outcome_model");
    reader.add_event(108, 42, "end", "model_outcome_model");
    return reader;
}
#include <stan_meta_header.hpp>
class model_outcome_model
  : public stan::model::model_base_crtp<model_outcome_model> {
private:
        int S;
        int N;
        int n;
...
public:
    model_outcome_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_outcome_model_namespace::model_outcome_model";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_outcome_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_outcome_model_namespace::model_outcome_model stan_model;
#ifndef USING_R
