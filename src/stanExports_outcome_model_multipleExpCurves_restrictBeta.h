...
namespace model_outcome_model_multipleExpCurves_restrictBeta_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_outcome_model_multipleExpCurves_restrictBeta");
    reader.add_event(7, 7, "include", "/data/outcome_dim.stan");
    reader.add_event(7, 0, "start", "/data/outcome_dim.stan");
    reader.add_event(15, 8, "end", "/data/outcome_dim.stan");
    reader.add_event(15, 8, "restart", "model_outcome_model_multipleExpCurves_restrictBeta");
    reader.add_event(16, 9, "include", "/data/outcome_data.stan");
    reader.add_event(16, 0, "start", "/data/outcome_data.stan");
    reader.add_event(24, 8, "end", "/data/outcome_data.stan");
    reader.add_event(24, 10, "restart", "model_outcome_model_multipleExpCurves_restrictBeta");
    reader.add_event(26, 12, "include", "/data/outcome_hyperprior.stan");
    reader.add_event(26, 0, "start", "/data/outcome_hyperprior.stan");
    reader.add_event(38, 12, "end", "/data/outcome_hyperprior.stan");
    reader.add_event(38, 13, "restart", "model_outcome_model_multipleExpCurves_restrictBeta");
    reader.add_event(44, 19, "include", "/data/outcome_tdata.stan");
    reader.add_event(44, 0, "start", "/data/outcome_tdata.stan");
    reader.add_event(47, 3, "end", "/data/outcome_tdata.stan");
    reader.add_event(47, 20, "restart", "model_outcome_model_multipleExpCurves_restrictBeta");
    reader.add_event(49, 22, "include", "/parameters/parameters_outcome.stan");
    reader.add_event(49, 0, "start", "/parameters/parameters_outcome.stan");
    reader.add_event(59, 10, "end", "/parameters/parameters_outcome.stan");
    reader.add_event(59, 23, "restart", "model_outcome_model_multipleExpCurves_restrictBeta");
    reader.add_event(64, 28, "include", "tparameters/tparameters_outcome_define.stan");
    ...
    reader.add_event(69, 29, "restart", "model_outcome_model_multipleExpCurves_restrictBeta");
    reader.add_event(70, 30, "include", "tparameters/tparameters_outcome_update.stan");
    ...
    reader.add_event(82, 31, "restart", "model_outcome_model_multipleExpCurves_restrictBeta");
    reader.add_event(88, 37, "include", "/model/model_stem_outcome.stan");
    reader.add_event(88, 0, "start", "/model/model_stem_outcome.stan");
    reader.add_event(102, 14, "end", "/model/model_stem_outcome.stan");
    reader.add_event(102, 38, "restart", "model_outcome_model_multipleExpCurves_restrictBeta");
    reader.add_event(113, 47, "end", "model_outcome_model_multipleExpCurves_restrictBeta");
    return reader;
}
#include <stan_meta_header.hpp>
class model_outcome_model_multipleExpCurves_restrictBeta
  : public stan::model::model_base_crtp<model_outcome_model_multipleExpCurves_restrictBeta> {
private:
        int S;
        int N;
        int n;
...
public:
    model_outcome_model_multipleExpCurves_restrictBeta(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_outcome_model_multipleExpCurves_restrictBeta_namespace::model_outcome_model_multipleExpCurves_restrictBeta";
        ...
        try {
            ...
            context__.validate_dims("data initialization", "beta_lower_lim", "double", context__.to_vec());
            beta_lower_lim = double(0);
            vals_r__ = context__.vals_r("beta_lower_lim");
            pos__ = 0;
            beta_lower_lim = vals_r__[pos__++];
            ...
            context__.validate_dims("data initialization", "beta_nu", "double", context__.to_vec());
            beta_nu = double(0);
            vals_r__ = context__.vals_r("beta_nu");
            pos__ = 0;
            beta_nu = vals_r__[pos__++];
            check_greater_or_equal(function__, "beta_nu", beta_nu, 0);
            ...
            validate_non_negative_index("beta_raw", "S", S);
            validate_non_negative_index("beta_raw", "xdf", xdf);
            num_params_r__ += (S * xdf);
    ...
    ~model_outcome_model_multipleExpCurves_restrictBeta() { }
    void transform_inits(const stan::io::var_context& context__,
        ...
        validate_non_negative_index("beta_raw", "S", S);
        validate_non_negative_index("beta_raw", "xdf", xdf);
        context__.validate_dims("parameter initialization", "beta_raw", "matrix_d", context__.to_vec(S,xdf));
        Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> beta_raw(S, xdf);
        size_t beta_raw_j_2_max__ = xdf;
        size_t beta_raw_j_1_max__ = S;
        ...
        try {
            writer__.matrix_lb_unconstrain(((beta_lower_lim - prior_beta_mean) / sigmaBeta), beta_raw);
        } catch (const std::exception& e) {
        ...
        validate_non_negative_index("L", "S", S);
        validate_non_negative_index("L", "S", S);
        context__.validate_dims("parameter initialization", "L", "matrix_d", context__.to_vec(S,S));
        Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> L(S, S);
        size_t L_j_2_max__ = S;
        size_t L_j_1_max__ = S;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                beta_raw = in__.matrix_lb_constrain(((beta_lower_lim - prior_beta_mean) / sigmaBeta), S, xdf, lp__);
            else
                beta_raw = in__.matrix_lb_constrain(((beta_lower_lim - prior_beta_mean) / sigmaBeta), S, xdf);
            current_statement_begin__ = 62;
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, Eigen::Dynamic> L;
            (void) L;  // dummy to suppress unused var warning
            if (jacobian__)
                L = in__.cholesky_factor_corr_constrain(S, lp__);
            else
                L = in__.cholesky_factor_corr_constrain(S);
            ...
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, Eigen::Dynamic> beta(S, xdf);
            ...
            if (as_bool(logical_gt(xdf, 0))) {
                ...
                stan::math::assign(beta, add(prior_beta_mean, multiply(L, multiply(sigmaBeta, beta_raw))));
                current_statement_begin__ = 85;
                stan::math::assign(mui, add(mui, rows_dot_product(Mx, stan::model::rvalue(beta, stan::model::cons_list(stan::model::index_multi(study_of_obs), stan::model::nil_index_list()), "beta"))));
            }
            ...
            check_greater_or_equal(function__, "beta", beta, beta_lower_lim);
            // model body
            ...
            lp_accum__.add(binomial_logit_log(y, nT, mui));
            current_statement_begin__ = 103;
            lp_accum__.add(normal_log(to_vector(beta_raw), 0, 1));
            current_statement_begin__ = 104;
            lp_accum__.add(lkj_corr_cholesky_log(L, beta_nu));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_outcome_model_multipleExpCurves_restrictBeta_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> beta_raw = in__.matrix_lb_constrain(((beta_lower_lim - prior_beta_mean) / sigmaBeta), S, xdf);
        size_t beta_raw_j_2_max__ = xdf;
        size_t beta_raw_j_1_max__ = S;
        for (size_t j_2__ = 0; j_2__ < beta_raw_j_2_max__; ++j_2__) {
            for (size_t j_1__ = 0; j_1__ < beta_raw_j_1_max__; ++j_1__) {
        ...
        Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> L = in__.cholesky_factor_corr_constrain(S);
        size_t L_j_2_max__ = S;
        size_t L_j_1_max__ = S;
        for (size_t j_2__ = 0; j_2__ < L_j_2_max__; ++j_2__) {
            for (size_t j_1__ = 0; j_1__ < L_j_1_max__; ++j_1__) {
        ...
        try {
            ...
            validate_non_negative_index("beta", "S", S);
            validate_non_negative_index("beta", "xdf", xdf);
            Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> beta(S, xdf);
            stan::math::initialize(beta, DUMMY_VAR__);
            stan::math::fill(beta, DUMMY_VAR__);
            ...
            validate_non_negative_index("betaCorr", "S", S);
            validate_non_negative_index("betaCorr", "S", S);
            Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> betaCorr(S, S);
            stan::math::initialize(betaCorr, DUMMY_VAR__);
            stan::math::fill(betaCorr, DUMMY_VAR__);
            // generated quantities statements
            current_statement_begin__ = 109;
            stan::math::assign(betaCorr, multiply_lower_tri_self_transpose(L));
            // validate, write generated quantities
            current_statement_begin__ = 108;
            size_t betaCorr_j_2_max__ = S;
            size_t betaCorr_j_1_max__ = S;
            for (size_t j_2__ = 0; j_2__ < betaCorr_j_2_max__; ++j_2__) {
                for (size_t j_1__ = 0; j_1__ < betaCorr_j_1_max__; ++j_1__) {
                    vars__.push_back(betaCorr(j_1__, j_2__));
                }
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
    ...
    std::string model_name() const {
        return "model_outcome_model_multipleExpCurves_restrictBeta";
    }
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        for (size_t j_2__ = 0; j_2__ < betaCorr_j_2_max__; ++j_2__) {
            for (size_t j_1__ = 0; j_1__ < betaCorr_j_1_max__; ++j_1__) {
                param_name_stream__.str(std::string());
                param_name_stream__ << "betaCorr" << '.' << j_1__ + 1 << '.' << j_2__ + 1;
                param_names__.push_back(param_name_stream__.str());
            }
        }
    }
...
typedef model_outcome_model_multipleExpCurves_restrictBeta_namespace::model_outcome_model_multipleExpCurves_restrictBeta stan_model;
#ifndef USING_R
