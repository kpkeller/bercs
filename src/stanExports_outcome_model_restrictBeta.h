...
namespace model_outcome_model_restrictBeta_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_outcome_model_restrictBeta");
    ...
    reader.add_event(14, 7, "restart", "model_outcome_model_restrictBeta");
    ...
    reader.add_event(23, 9, "restart", "model_outcome_model_restrictBeta");
    reader.add_event(25, 11, "include", "/data/outcome_hyperprior.stan");
    reader.add_event(25, 0, "start", "/data/outcome_hyperprior.stan");
    reader.add_event(37, 12, "end", "/data/outcome_hyperprior.stan");
    reader.add_event(37, 12, "restart", "model_outcome_model_restrictBeta");
    ...
    reader.add_event(45, 18, "restart", "model_outcome_model_restrictBeta");
    ...
    reader.add_event(57, 21, "restart", "model_outcome_model_restrictBeta");
    reader.add_event(61, 25, "include", "tparameters/tparameters_outcome_define.stan");
    reader.add_event(61, 0, "start", "tparameters/tparameters_outcome_define.stan");
    reader.add_event(66, 5, "end", "tparameters/tparameters_outcome_define.stan");
    reader.add_event(66, 26, "restart", "model_outcome_model_restrictBeta");
    reader.add_event(67, 27, "include", "tparameters/tparameters_outcome_update.stan");
    reader.add_event(67, 0, "start", "tparameters/tparameters_outcome_update.stan");
    reader.add_event(79, 12, "end", "tparameters/tparameters_outcome_update.stan");
    reader.add_event(79, 28, "restart", "model_outcome_model_restrictBeta");
    ...
    reader.add_event(100, 36, "restart", "model_outcome_model_restrictBeta");
    reader.add_event(107, 41, "end", "model_outcome_model_restrictBeta");
    return reader;
}
#include <stan_meta_header.hpp>
class model_outcome_model_restrictBeta
  : public stan::model::model_base_crtp<model_outcome_model_restrictBeta> {
private:
        int S;
        int N;
        int n;
...
public:
    model_outcome_model_restrictBeta(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_outcome_model_restrictBeta_namespace::model_outcome_model_restrictBeta";
    ...
    ~model_outcome_model_restrictBeta() { }
    void transform_inits(const stan::io::var_context& context__,
        ...
        try {
            writer__.vector_lb_unconstrain(((beta_lower_lim - prior_beta_mean) / sigmaBeta), beta_raw);
        } catch (const std::exception& e) {
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                beta_raw = in__.vector_lb_constrain(((beta_lower_lim - prior_beta_mean) / sigmaBeta), xdf, lp__);
            else
                beta_raw = in__.vector_lb_constrain(((beta_lower_lim - prior_beta_mean) / sigmaBeta), xdf);
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_outcome_model_restrictBeta_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        Eigen::Matrix<double, Eigen::Dynamic, 1> beta_raw = in__.vector_lb_constrain(((beta_lower_lim - prior_beta_mean) / sigmaBeta), xdf);
        size_t beta_raw_j_1_max__ = xdf;
        for (size_t j_1__ = 0; j_1__ < beta_raw_j_1_max__; ++j_1__) {
    ...
    std::string model_name() const {
        return "model_outcome_model_restrictBeta";
    }
...
typedef model_outcome_model_restrictBeta_namespace::model_outcome_model_restrictBeta stan_model;
#ifndef USING_R
