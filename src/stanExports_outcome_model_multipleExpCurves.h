...
namespace model_outcome_model_multipleExpCurves_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_outcome_model_multipleExpCurves");
    reader.add_event(6, 6, "include", "/data/outcome_dim.stan");
    reader.add_event(6, 0, "start", "/data/outcome_dim.stan");
    reader.add_event(14, 8, "end", "/data/outcome_dim.stan");
    reader.add_event(14, 7, "restart", "model_outcome_model_multipleExpCurves");
    reader.add_event(15, 8, "include", "/data/outcome_data.stan");
    reader.add_event(15, 0, "start", "/data/outcome_data.stan");
    reader.add_event(23, 8, "end", "/data/outcome_data.stan");
    reader.add_event(23, 9, "restart", "model_outcome_model_multipleExpCurves");
    reader.add_event(24, 10, "include", "/data/outcome_hyperprior.stan");
    reader.add_event(24, 0, "start", "/data/outcome_hyperprior.stan");
    reader.add_event(36, 12, "end", "/data/outcome_hyperprior.stan");
    reader.add_event(36, 11, "restart", "model_outcome_model_multipleExpCurves");
    reader.add_event(42, 17, "include", "/data/outcome_tdata.stan");
    reader.add_event(42, 0, "start", "/data/outcome_tdata.stan");
    reader.add_event(45, 3, "end", "/data/outcome_tdata.stan");
    reader.add_event(45, 18, "restart", "model_outcome_model_multipleExpCurves");
    reader.add_event(47, 20, "include", "/parameters/parameters_outcome.stan");
    reader.add_event(47, 0, "start", "/parameters/parameters_outcome.stan");
    reader.add_event(57, 10, "end", "/parameters/parameters_outcome.stan");
    reader.add_event(57, 21, "restart", "model_outcome_model_multipleExpCurves");
    reader.add_event(62, 26, "include", "tparameters/tparameters_outcome_define.stan");
    reader.add_event(62, 0, "start", "tparameters/tparameters_outcome_define.stan");
    reader.add_event(67, 5, "end", "tparameters/tparameters_outcome_define.stan");
    reader.add_event(67, 27, "restart", "model_outcome_model_multipleExpCurves");
    reader.add_event(68, 28, "include", "tparameters/tparameters_outcome_update.stan");
    reader.add_event(68, 0, "start", "tparameters/tparameters_outcome_update.stan");
    reader.add_event(80, 12, "end", "tparameters/tparameters_outcome_update.stan");
    reader.add_event(80, 29, "restart", "model_outcome_model_multipleExpCurves");
    reader.add_event(86, 35, "include", "/model/model_stem_outcome.stan");
    reader.add_event(86, 0, "start", "/model/model_stem_outcome.stan");
    reader.add_event(100, 14, "end", "/model/model_stem_outcome.stan");
    reader.add_event(100, 36, "restart", "model_outcome_model_multipleExpCurves");
    reader.add_event(111, 45, "end", "model_outcome_model_multipleExpCurves");
    return reader;
}
#include <stan_meta_header.hpp>
class model_outcome_model_multipleExpCurves
  : public stan::model::model_base_crtp<model_outcome_model_multipleExpCurves> {
private:
        int S;
        int N;
        int n;
...
public:
    model_outcome_model_multipleExpCurves(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_outcome_model_multipleExpCurves_namespace::model_outcome_model_multipleExpCurves";
    ...
    ~model_outcome_model_multipleExpCurves() { }
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                beta_raw = in__.matrix_constrain(S, xdf, lp__);
            else
                beta_raw = in__.matrix_constrain(S, xdf);
            current_statement_begin__ = 60;
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_outcome_model_multipleExpCurves_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> beta_raw = in__.matrix_constrain(S, xdf);
        size_t beta_raw_j_2_max__ = xdf;
        size_t beta_raw_j_1_max__ = S;
        for (size_t j_2__ = 0; j_2__ < beta_raw_j_2_max__; ++j_2__) {
            for (size_t j_1__ = 0; j_1__ < beta_raw_j_1_max__; ++j_1__) {
    ...
    std::string model_name() const {
        return "model_outcome_model_multipleExpCurves";
    }
...
typedef model_outcome_model_multipleExpCurves_namespace::model_outcome_model_multipleExpCurves stan_model;
#ifndef USING_R
